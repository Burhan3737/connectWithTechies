...
|---|---:|---:|---|
| `confirmed` | 260 | 29.1% | checked against the organiser's page, correct as recorded — **skip these** |
| `corrected` | 76 | 8.5% | checked, found wrong, patched — **skip these** |
| `blocked` | 25 | 2.8% | attempted, page unreadable by fetch — **needs a web search or a human with a browser** |
| _unchecked_ | 533 | 59.6% | never attempted — **verify these first** |
...
## Ledger rows with no matching event (18)
